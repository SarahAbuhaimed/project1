...
If you are feeling creative and want to try something new, then go for it!  In order to go this route you must run your idea by Marc, Ebere or Alanoud first.
...
* Projects are due Wednesday, 13/3 at midnight!  Submissions should be made as a pull request to THIS REPO. * 
